<?php
/**
 * Script de Automatización: Expected Conditions - Presence (SIN PHPUnit)
 *
 * Este script:
...
class Clase13_Presence
{
    ...
    public function ejecutar()
    {
        ...
        try {
            ...
            if ($elemento !== null) {
                echo "═════════════════════════════════════\n";
                echo "✓ RESULTADO: Elemento presente en el DOM\n";
                echo "═════════════════════════════════════\n\n";
            }
    ...
    {
        echo "[1/3] Iniciando ChromeDriver...\n";
    ...
    {
        echo "[2/3] Conectando con WebDriver...\n";
