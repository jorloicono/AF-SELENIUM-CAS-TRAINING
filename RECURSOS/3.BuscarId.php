...
class Clase3_BuscarElementoPorElId
{
    private $driver;
    ...
    /**
     * Busca un elemento por su ID y hace clic
     */
    private function buscarYHacerClicPorId($id)
    {
        echo "[4/5] Buscando elemento con ID: '$id'...\n";

        try {
            // Buscar el elemento por ID
            $elemento = $this->driver->findElement(WebDriverBy::id($id));
    ...
    public function ejecutar()
    {
        try {
            ...
            // Buscar el elemento con id ca-history y hacer clic
            $this->buscarYHacerClicPorId('ca-history');
...
// Ejecutar el script
try {
    $script = new Clase3_BuscarElementoPorElId();
    $script->ejecutar();
    echo "\n========== PROCESO COMPLETADO ==========\n\n";
} catch (Exception $e) {
